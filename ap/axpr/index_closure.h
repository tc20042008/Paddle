...
struct IndexClosureData {
  const ap::axpr::index_expr::Val ctx;
  const adt::List<ap::axpr::index_expr::Val> inputs_meta;
  const adt::List<ap::axpr::index_expr::Val> outputs_meta;
  const adt::List<ap::axpr::index_expr::Val> in_vars;
...
using TrackedIndexesTransformImpl =
    std::variant<adt::IdentityFunc, ap::axpr::IndexTupleExpr>;
...
using OpIndexesTransformSignature =
    ap::axpr::OpSignature<TrackedIndexesTransform>;
