...
struct CodeGenCtxMethodClass {
  ...
  adt::Result<ValueT> CudaCodeGen(const Self& self,
    ...
    ADT_CHECK(args->size() == 1) << adt::errors::TypeError{
        "'CodeGenCtx.cuda_code_gen' takes 1 positional arguments but " +
        std::to_string(args->size()) + " were given."};
    ADT_LET_CONST_REF(ir_op, IrOp<BirNode>::CastFrom(args->at(0)))
        << adt::errors::TypeError{
               std::string() +
               "the positional argument 1 of 'CodeGenCtx.cuda_code_gen' should "
    ...
    ADT_LET_CONST_REF(kernel_arg_id2arg_name_val,
        ...
        << adt::errors::TypeError{
               std::string() +
               "cuda_code_gen() requires 'OrderedDict' typed keyword argument "
               "'kernel_arg_id_to_arg_name'."};
    ...
    ADT_LET_CONST_REF(loop_index_tuple_expr,
        ...
        << adt::errors::TypeError{
               std::string() +
               "'CodeGenCtx.cuda_code_gen' requires 'IndexTupleExpr' typed "
    ...
    std::vector<std::string> loop_var_names{};
    {
      ADT_LET_CONST_REF(
          ...
          << adt::errors::TypeError{
                 std::string() +
                 "'CodeGenCtx.cuda_code_gen' requires 'list' "
      ...
      for (const auto& elt : *loop_var_names_val) {
        ADT_LET_CONST_REF(loop_var_name, axpr::TryGetImpl<std::string>(elt))
            << adt::errors::TypeError{
                   ...
                   "'CodeGenCtx.cuda_code_gen' should be a list of string."};
    ...
    ADT_LET_CONST_REF(
        ...
        << adt::errors::TypeError{std::string() +
                                  ...
                                  "'CodeGenCtx.cuda_code_gen' should be a str"};
    std::vector<LocalVarBinding<BirNode>> local_var_name_bindings{};
    {
      ADT_LET_CONST_REF(
          ...
          << adt::errors::TypeError{
                 std::string() +
                 "'CodeGenCtx.cuda_code_gen' requires 'list' typed keyword "
      ...
      for (const auto& elt : *local_var_name_bindings_val) {
        ADT_LET_CONST_REF(pair, axpr::TryGetImpl<adt::List<ValueT>>(elt))
            << adt::errors::TypeError{
                   ...
                   "'CodeGenCtx.cuda_code_gen' should be a list of pair."};
        ...
        ADT_LET_CONST_REF(local_var_name,
            ...
            << adt::errors::TypeError{
                   std::string() +
                   "keyword argument 'local_var_name_bindings' of "
                   "'CodeGenCtx.cuda_code_gen' should be a list of pair(str, "
                   "NativeIrValue)."};
