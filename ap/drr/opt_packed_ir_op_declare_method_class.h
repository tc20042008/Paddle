...
struct MethodClassImpl<ValueT, drr::OptPackedIrOpDeclare<ValueT, NodeT>> {
  using Self = drr::PackedIrOpDeclare<ValueT, NodeT>;
...
struct MethodClassImpl<ValueT,
                       TypeImpl<drr::OptPackedIrOpDeclare<ValueT, NodeT>>> {};
