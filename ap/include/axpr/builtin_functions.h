...
#include <functional>
#include <sstream>
#include "ap/include/axpr/abstract_list.h"
#include "ap/include/axpr/bool_int_double_helper.h"
#include "ap/include/axpr/builtin_high_order_func_type.h"
#include "ap/include/axpr/data_value_util.h"
#include "ap/include/axpr/method_class.h"
#include "ap/include/axpr/string_util.h"
...
adt::Result<bool> ConvertToBool(const Val& cond) {
  ...
  return cond.Match(
      ...
      [](const AttrMap<Val>& obj) -> Result<bool> { return obj->size() > 0; },
...
template <typename ValueT>
adt::Result<ValueT> Print(InterpreterBase<ValueT>* interpreter,
                          const ValueT&,
