...
#include "ap/kernel_define/arg_source_helper.h"
...
#include "ap/kernel_define/kernel_arg_id_ordered_set.h"
...
template <typename ValueT, typename BirNode>
struct MethodClassImpl<ValueT, ap::kernel_define::DefineCtx<BirNode>>
    : public ap::kernel_define::DefineCtxMethodClass<ValueT, BirNode> {};

template <typename ValueT, typename BirNode>
struct MethodClassImpl<ValueT, TypeImpl<ap::kernel_define::DefineCtx<BirNode>>>
