...
template <typename ValueT, typename BirNode /* background ir node */>
struct MethodClassImpl<ValueT, kernel_define::DimExprKernelArgId<BirNode>>
    : public kernel_define::DimExprKernelArgIdMethodClass<ValueT, BirNode> {};

template <typename ValueT, typename BirNode /* background ir node */>
struct MethodClassImpl<ValueT,
                       TypeImpl<kernel_define::DimExprKernelArgId<BirNode>>>
    : public kernel_define::TypeImplDimExprKernelArgIdMethodClass<ValueT,
                                                                  BirNode> {};
