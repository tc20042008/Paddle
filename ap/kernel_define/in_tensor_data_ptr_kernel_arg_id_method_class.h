...
struct MethodClassImpl<ValueT,
                       kernel_define::InTensorDataPtrKernelArgId<BirNode>>
    : public kernel_define::InTensorDataPtrKernelArgIdMethodClass<ValueT,
                                                                  BirNode> {};

template <typename ValueT, typename BirNode /* background ir node */>
struct MethodClassImpl<
    ValueT,
    TypeImpl<kernel_define::InTensorDataPtrKernelArgId<BirNode>>>
    : public kernel_define::
          TypeImplInTensorDataPtrKernelArgIdMethodClass<ValueT, BirNode> {};
