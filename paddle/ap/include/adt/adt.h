...
#define ADT_DEFINE_VARIANT_METHODS(...)                                \
  ADT_DEFINE_VARIANT_METHODS_WHITOUT_TRYGET(__VA_ARGS__)               \
...
#define ADT_DEFINE_VARIANT_METHODS_WHITOUT_TRYGET(...)                 \
  DEFINE_MATCH_METHOD();                                               \
...
struct Either : public EitherImpl<T0, T1> {
  ...
  ADT_DEFINE_VARIANT_METHODS_WHITOUT_TRYGET(EitherImpl<T0, T1>);
};
...
struct [[nodiscard]] Error : public ErrorBase {
  ...
  ADT_DEFINE_VARIANT_METHODS_WHITOUT_TRYGET(ErrorBase);
